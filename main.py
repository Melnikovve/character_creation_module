...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == "mage":
        return f"{char_name} нанёс урон противнику равный" f"{5 + randint(5, 10)}"
    if char_class == "healer":
        return f"{char_name} нанёс урон противнику равный" f"{5 + randint(-3, -1)}"
...
def special(char_name: str, char_class: str) -> str:
    """Применяет скилл."""
    if char_class == "warrior":
        return f"{char_name} применил специальное умение «Выносливость" f" {80 + 25}»"
    if char_class == "mage":
...
def start_training(char_name: str, char_class: str) -> str:
    """Определение уровня и тренировка."""
    if char_class == "warrior":
